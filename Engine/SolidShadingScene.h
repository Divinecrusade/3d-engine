...
class SolidShadingScene : public IScene
{
public:

	SolidShadingScene(Graphics& gfx)
		:
		pip{ gfx, SolidShadingEffect{ } }
	{
	...
	{
		pip.BeginFrame();
		auto model{ Cube::GetTrianglesWithNormals<SolidShadingEffect::VertexWithNormale>(1.f) };
		pip.Draw(model);
	}

private:

	Pipeline<SolidShadingEffect> pip;
